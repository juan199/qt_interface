...
void MainWindow::start_mp3()
{
    // Start the mp3 reproducer with default playlist
    QDir directory("/home/juan/Downloads/");
    ...
    foreach (QString const &argument, songs) {
...
void MainWindow::on_actionOpen_triggered()
{
        ...
        QStringList songs;
        songs.clear();
        songs = QFileDialog::getOpenFileNames(this,"Open mp3 Files","","mp3 File(*.mp3 *MP3)");
