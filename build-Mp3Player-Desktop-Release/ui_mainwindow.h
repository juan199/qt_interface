...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMaximumSize(QSize(400, 420));
        QIcon icon;
        ...
        dial->setGeometry(QRect(270, 250, 121, 111));
        dial->setValue(50);
        progressBar = new QProgressBar(centralWidget);
        progressBar->setObjectName(QStringLiteral("progressBar"));
        progressBar->setGeometry(QRect(280, 360, 121, 10));
        progressBar->setMaximumSize(QSize(16777215, 10));
        progressBar->setValue(50);
        status = new QLabel(centralWidget);
        status->setObjectName(QStringLiteral("status"));
        status->setGeometry(QRect(280, 376, 101, 20));
        status->setFont(font);
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 330, 242, 66));
        ...
        prebutton->setMinimumSize(QSize(32, 32));
        ...
        layoutWidget1->setGeometry(QRect(220, 250, 62, 31));
        ...
        shuffle->setMinimumSize(QSize(24, 24));
        shuffle->setMaximumSize(QSize(16, 16));
        ...
        mute->setMinimumSize(QSize(30, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        time->setText(QApplication::translate("MainWindow", "00:00", 0));
        art->setText(QString());
